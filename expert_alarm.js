...
//  · 保底 full：npb 12/15/18、kbo 12:30/15:30/18:30、cpbl 13/16、mlb 22/23:30/1/2:30（台灣時間）
//  · 深掃（EP_DEEP 全名冊）：npb 03:40、kbo 04:00、cpbl 04:20、mlb 04:00；深掃不受無賽日規則影響
//    （mlb 2026-07-27 使用者拍板：保底 1.5h 一波、04:00 收在深掃，原 06:00 深掃取消）
//  · 無賽日規則：該保底時點往後 24h 內沒有任何比賽 → 跳過該保底
//  · 錯過補償：目標已過 ≤35 分且晚於上一波、未晚於開賽+10 分 → sleepSec=0 立刻抓（>60s 才標「補償」）
...
const BASELINES = {
  ...
  // wnba 比賽=台灣早晨(07~11)，高手深夜持續貼隔日早場單（與 mlb 同型態）→ 夜間 1.5h 節奏
  // （2026-08-04 使用者實查 22:00 後 6.7h 無更新＝原 12/18/22 三波的設計空窗,非故障）
  wnba: { hot: [[12,0],[15,0],[18,0],[22,0],[23,30],[1,0],[2,30]], deep: [4,40] },
